...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("rsabino/ipinfo")
    client.subscribe("rsabino/date")
    client.subscribe("rsabino/time")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("rsabino/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("rsabino/date", on_message_from_date)
    client.message_callback_add("rsabino/time", on_message_from_time)
